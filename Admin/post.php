...
if ($number == "1") {
if ($_POST[submit]) {
$sql = "INSERT INTO $pagestable (title, page) VALUES ('$_POST[titlepage]', '$_POST[news]')";
...
<tr>
<td><input type="Text" size="45" name="titlepage" style="background-color: <?echo"$color5" ?>; border: 1 solid <?echo"$color1" ?>" class="text"><br></td>
</tr>
<tr>

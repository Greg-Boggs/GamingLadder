...
$teamladdermode = TRUE; //switch for enabling 2v2 teamladder
$teamtable = "webl_teams"; //name of the table that stores the information about the teams

define ("TEAM_MEMBER_NUMBER", 4); // defines of how many people form a team (2 for 2v2 ladder...)
...
$laddermailsender = "test@dot.com"; // this will be the senders email when the ladder sends a mail to someone... 
 ...
 $databasename = "2v2ladder"; //the name of your database
...
$gamestorank = 1; // number of games a player must have played in order to get a ranking (not the same as getting an elo rating!)

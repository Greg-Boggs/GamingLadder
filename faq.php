...
<ol>
	...
	players that have played one or more games always have a rating.</li>
...
<ol>
	...
	messenger</a> and also email challenge them via their profile.</li>
	<li>Game must be played on one of the <em>Official Servers</em> using the
	original unmodified software.</li>
	...
	wesnoth.org download section links to.</li>
	<li>The loading of Saved Games isn't allowed unless you both explicitly agree
	that it is or the rules suggest it.</li>
	<li>Currently the only legit era is the <em>Default</em> one. No other eras are
	accepted. Once a Ladder Era is created it will be used for Ladder games.</li>
	...
	and friendly to allow observers.</li>
</ol>
...
<ol>
	...
	<em>between</em> the observers may occur in any language.</li>
	<li>The <em>winner</em> of the game is allowed to report the result to the
	ladder after each finished game. The loser isn't.</li>
	...
	the players <em>all agree </em>on it.</li>
	...
	instead. The correct settings are defined in this document.</li>
	<li>Always save a replay of your game - it might be of value in the future
	and will also prevent the most common cheaters.</li>
	...
	loaded according to the above.</li>
	...
	allowed to go ahead and report the match as a win.</li>
</ol>
...
<ol>
	...
	report correct ones, abuse or exploit this system in any way.</li>
	...
	current Ladder Admin can be found at the bottom of this page.</li>
	...
	anything productive.</li>
	<li>Using this ladder and our services isn't a right - it's a privilege that
	we choose to give to you as long as we want and as long as it's possible.</li>
	...
	integrity and the intended functions of it as the admin envisions them.</li>
	...
	the news section as well as in here.</li>
</ol>
...
<ol>
	...
	<em>will tell you</em> this when you try to log in.</li>
	...
	welcome e-mail, we included it there for you to remember it better.</li>
...
<ul>
	...
	never report false/wrong.</li>
	<li>You played a game and won or lost, and it was reported. Hence your Elo
	would change. Check your game history to see if it refreshes your memory.</li>
	...
	trying to get in touch with that person.</li>
	...
	have retroactive effects in the name of fairness.</li>
</ul>
...
<ol>
	...
	make contact by using an instant messenger.</li>
</ol>
...
<ul>
	...
	to contact us as we want some more simple functions added to the system.</li>
...
<ul>
	...
	bad or for other reasons an unwanted thing which should be opposed.</li>
	...
	denied, because the ladder is not official.</li>
</ul>

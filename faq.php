...
<i>Faq v.0.2 - 5 June 2008</i><br><br>

<b>Table of Content</b>
<ol>
<LI><a href="faq.php#mrules">Rules</a></LI>
<LI><a href="faq.php#magreement">Agreement</a></LI>
<li><a href="faq.php#mfaq">Faq</a></li>
</ol>
...
<br>
<a name="mrules"><b><h2>Rules</h2></b></a>
<b>Ladder Rating & Ranking</b>
<ol><li>To be <em>rated</em> you just need to play a game. The more games you play against different opponents, the more accurate your rating becomes. All players that have played one or more games always have a rating.</li>
<li>To be <em>ranked</em> you must have played at least 1) <?php echo "$gamestorank" ?> games and 2) have played at least one game the recent <?php echo "$passivedays";?> days. The rank orders players by comparing their rating and also the amount of games they've played. The more, the better, in both cases.</li>
<li>To be listed in the ladder table you must 1) have a rating that's <?php echo "$ladderminelo"; ?> or above, 2) have played at least one game the recent <?php echo "$passivedays";?> days and 3) played at least  <?php echo "$gamestorank" ?> games in total. You can read the <A href="faq.php#passive">details here</a></li>.
</ol>

<b>Game setup</b>
<ol>
<li>All games are 1 vs 1. You're allowed to play however many games you want, with whoever that is participating in the ladder and that wants to compete with you. To find an opponent for a ladder game you'd have to contact people in the ladder and/or create (ladder) games on the offical server. You can find players by using the ladder <a href="http://chaosrealm.net/wesnoth/friends.php">in-game friends list</a>, contacting them via some kind of <a href="http://www.pidgin.im">instant messenger</a> and also email challange them via their profile.</li>
...
<a name="magreement"><h2><b>Agreement</b></h2></a>
<ol>
...
<a name="mfaq"><h2><b>FAQ</b></h2></a>
<a href="faq.php#what">What is this site?</a><br>
<a href="faq.php#howtoreport">How do I report the result of a game?</a><br>
<a href="faq.php#unranked">I've played x games. Why am I still unranked?</a><br>
<a href="faq.php#unladder">Why don't I show in the ladder listing?</a><br>
<a href="faq.php#cheaters">Won't people cheat?</a><br>
<a href="faq.php#logins">I can't login...</a><br>
<a href="faq.php#friends">Is there an easy way to add all ladder members as friends in-game?</a><br>
<a href="faq.php#suckage">Does my rating suck? Is having 1500 good?</a><br>
<a href="faq.php#passive">What does passive rank mode mean?</a><br>
<a href="faq.php#elochange">Help! My Elo points changed for no reason!</a><br>
<a href="faq.php#countdown">What is the countdown in days for in my profile?</a><br>
<a href="faq.php#avgp">Wtf is Average P W/L/T in the profile?</a><br>
<a href="faq.php#rulings">Where do I get a ruling?</a><br>
<a href="faq.php#rulessuck">The rules suck.</a><br>
<a href="faq.php#playnowlist">What is the stuff next to the players nick in the waiting for game list?</a><br>
<a href="faq.php#elo">How is the rating calculated?</a><br>
<a href="faq.php#projection">What are the points in () that I see in the profiles?</a><br>
<a href="faq.php#provisional">What is a provisional player?</a><br>
<a href="faq.php#protection">Won't players just play against weaker players?</a><br>
<a href="faq.php#nofun">It's not fun or a good idea to use a ranking system. The Wesnoth developers/community/santa is against it.</a><br>
<a href="faq.php#help">How can I help?</a><br>
<a href="faq.php#profile">How can I edit my profile?</a><br>
<a href="faq.php#avatars">What good are the avatars?</a><br>
<a href="faq.php#ideas">I have an idea. Who do I contact?</a><br>
<a href="faq.php#contact">How do I contact you?</a><br>
<a href="faq.php#graphics">Where's the graphics from?</a><br>
<a href="faq.php#aboutofficial">Why is the ladder not an official part of the Wesnoth community?</a><br>
<br>
<br>
<a name="what"><b>What is this site?</b></a><br>
It's a site that helps you keep track of your skills in the excellent open source game Battle for Wesnoth (wesnoth.org). By playing against others who also use the site you can report the results of your games and get a rating. You can also use the system to find players of simillar skill. All you have to do to start participating is to Join, play a game against another person that uses the ladder, and then let the winner report the result of the game.<br><br>

<a name="howtoreport"><b>How do I report the result of a game?</b></a><br>
Granted you have created an account, you press Report in the main menu. You then tell us who the winner / loser is, and also your account password. That's it.<br><br>

<a name="unranked"><b>I've played x games. Why am I still unranked?</b></a><br>
You must play at least 3 games to get a ranking. The more games you play, the more accurate it gets. 3 is currently the bare minimum.<br><br>

<a name="unladder"><b>Why don't I show in the ladder listing?</b></a><br>
You show up in the ladder listing if you <i>are</i> ranked and also have a rating of at least <?php echo "$ladderminelo";?>. While any player can get to see his ranking, only the ranked players that have a rating of at least <?php echo "$ladderminelo";?> will appear on the ladders list. This is to keep it free from clutter and to only show the top players.<br><br>

<a name="cheaters"><b>Won't people cheat?</b></a><br>
In short, this is an imaginary problem. So the answer is no.<br>I've written a more extensive answer to this one <a href="http://www.wesnoth.org/wiki/Competitive_Gaming">in here</a>. <br><br>

<a name="logins"><b>I can't log in...</b></a><br>
...
<a name="friends"><b>Is there an easy way to add all ladder members as friends in-game?</b></a><br>
Yes. Amazing you asked that question ;) Use our always up to date <a href="friends.php">friendslist.</a><br><br>

<a name="suckage"><b>Does my rating suck? Is having 1500 good?</b></a><br>
Many players that are not familiar with Elo's Rating System believe that 1500 is a newcomers rating. Understand this: <em>It is not the case!</em> When a player registers at the ladder he/she gets a rating of 1500, but, that rating is really the expected rating of an <em>average player</em> and not of a newcomer to the game. This means that people that are new to the game or still learning it are <em>expected</em> to have a rating thats way lower than 1500. It's normal. A player who has been around for a while and knows the game is expected to be average and have around 1500, while a really skilled veteran would have a higher. As a reference, players that have around 2000 are considered strong, and those beyond 2500 grandmasters.<br><br>
...
<a name="passive"><b>What does passive rank mode mean?</b></a><br>
...
<a name="elochange"><b>Help! My Elo points changed for no reason!</b></a><br>
...
<a name="countdown"><b>What is the countdown in days for in my profile?</b></a><br>
...
It also let's the newcomers obtain a more correct rating faster. Keep in mind that a player with an Elo of 1500 is an average player that knows the game. We consider a player that has more than <?php echo MIDDLE_RATING;?> to be <i>very skilled</i> compared to most of the competition, and having about 2500 equals to a grand master. Statistically speaking it should be rare to see players which such high ratings, and only a few are expected to reach those numbers.<br><br>
The K value you get is based on your current Elo rating. These are the K-values we use:<br><ul><li>0 to <?php echo BOTTOM_RATING ." Elo points give a K value of ". BOTTOM_K_VAL; ?></li>
...
<a name="profile"><b>How can I edit my profile?</b></a><br>
Use <a href="http://ladder.subversiva.org/edit.php">this page</a> or the icon with the text Profile in the menu that appears once you've logged in.<br><br>

<a name="avatars"><b>What good are the Avatars?</b></a><br>
None at all. It's aesthetic, but we could implement an icon system like Battle.nets. For now it's just nice and let's you select something you like as a visual representation. If you miss an avatar plese send it to us if it's legal and if it's a *.gif that uses transparency & that is a maximum of 44 pixels high.<br><br>

<a name="ideas"><b>I have an idea for this system / it lacks a function, who do I tell?</b></a><br>
We don't have a php coder yet and need a guy (or girl) before we can start developing the system further. If you know basic php & mysql you are welcome to contact us already. If you want to you can also use this <a href="http://www.wesnoth.org/forum/viewtopic.php?t=17941">forum thread</a> to post your ideas.<br><br>

<a name="contact"><b>How do I contact you?</b></a><br>
Easiest way is to write me a mail >> eyerouge (thething) eyerouge (theotherone) com and to write it in english<br><br>

<a name="graphics"><b>Where's the graphics from?</b></a><br>
It's all from Wesnoth and/or it's community. We've used what we could find and what we believe is free under the nice license.<br><br>

<a name="aboutofficial"><b>Why is the ladder not an official part of the Wesnoth community?</b></a><br>
<ul>

...
$result = mysqli_query($db, "SELECT * FROM $standingscachetable
...
$result = mysqli_query($db, $sql);
list($passive, $daysleft) = mysqli_fetch_row($result);
*/
...
<table width="100%" cellpadding="1px">
    <tr>
        ...
        <td valign="top">
            ...
            <?php
            echo "<br/> <p class='text'><img src='graphics/flags/" .
                str_replace(' ', '_', $player['country']) .
                ".png' align='middle' border='1' alt='' />" . $player['country'] . "</p>";
...
<table class="tablesorter">
    ...
    <tr>
        <td>
            ...
            if (isset($_SESSION['username']) && $_SESSION['username'] && $player['MsgMe'] == "Yes") {

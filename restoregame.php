...
if (isset($_POST['submit'])) {
    ...
    $result = mysqli_query($db, $sql) or die("failed to select game to restore");
    ...
    $result = mysqli_query($db, $sql) or die("failed to restore game");
    ...
    $result = mysqli_query($db, $sql) or die("failed to select last game");
    $row = mysqli_fetch_array($result);

...
if (isset($_GET['q'])) {
  ...
  //get all teams in which the user a member, needed to fill out the form properly
	...
	$result = mysql_query($sql,$db);
		  ...
		  else {echo "Something was wrong with the sql query, couldnt fetch the users teams";}
...
?>
<p>Congratulations <?php echo $_SESSION['username']; ?> as part of team <?php echo $winner ?> you have defeated team <?php echo $loser; ?></p>
...
// Then we update the gamestable with the new rank.....
  ...
  <table>
    ...
    onsubmit="return confirm('Report win against ' + this.losername.value +'?')"  action="<?php echo $_SERVER['PHP_SELF']?>">
